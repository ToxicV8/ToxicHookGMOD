...
public:
	...
	bool IsValid() const;
	Vector GetPointOnCircumference(float radius, float angle);
	Vector GetPointOnCircumference(const float radius, const float angle) const;
...
inline Vector Vector::GetPointOnCircumference(const float radius, const float angle)
{
	Vector vec = Vector(x + radius * cos(angle), y + radius * sin(angle));
	return vec;
}

inline Vector Vector::GetPointOnCircumference(const float radius, const float angle) const
{
	Vector vec = Vector(x + radius * cos(angle), y + radius * sin(angle));
	return vec;
}
...
inline Vector::Vector(float cx, float cy)
{
	x = cx;
	y = cy;
}
